...
SubEntity!(WorkAvailability ("Availability data for Works") {
    status: String,
...
Entity!(WorkEntity ("Representation of an OpenLibrary Work") {
...
Entity!(AuthorEntity ("Representation of an OpenLibrary Author") {
    name: String,
...
Entity!(SubjectEntity ("Representation of an OpenLibrary Subject") {
    name: String,
    subject_type: String,
    work_count: u64,
    count: u64
